...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  // Save directly into /public/assets/team with a random name (we'll rename right after)
  ...
  try {
    ...
    // Rename to our deterministic, human-friendly filename
    ...
    // This is the path your frontend should store in employee.image
